const AVAILABLE_WEEK_DAYS = ['Poniedziałek', 'Wtorek', 'Środa', 'Czwartek', 'Piątek', 'Sobota' , 'Niedziela'];
...
// App methods
    ...
    drawEvents() {
        ...
        let eventList = this.eventList[calendar.active.formatted] || ['Brak wydarzeń'];
        let eventTemplate = "";
    ...
    drawMonths() {
        let availableMonths = ["Sty", "Lut", "Mar", "Kwi", "Maj", "Cze", "Lip", "Sie", "Wrz", "Paź", "Lis", "Gru"];
        let monthTemplate = "";
        let calendar = this.getCalendar();
